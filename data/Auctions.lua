...
local Auctions = {};
ProfitAdvisor.Data.Auctions = Auctions;

-- Events
function Auctions:WindowOpened()
    ProfitAdvisor:Print("AH Window Opened");
end

function Auctions:WindowClosed()
    ProfitAdvisor:Print("AH Window Closed");
end

-- function Auctions:GetAuctionInfoForItem(itemID)
-- end
...
function Auctions:waitForScanFinish()    
